...
function preload() {
  ...
  robotSpritesheet = loadImage("ezgif.com-gif-maker-dino-spritesheet-removebg-preview.png");
}
...
function setup() {
  ...
  var dinoFrames = dinoSpritedata.frames;
  for (var i = 0; i < dinoFrames.length; i++) {
    var pos = dinoFrames[i].position;
    var img = dinoSpritesheet.get(pos.x, pos.y, pos.w, pos.h);
